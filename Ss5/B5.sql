...
select s.name, s.email, c.course_name, c.fee, e.enrollment_date from enrollments e
join students s on s.student_id = e.student_id
join courses c on c.course_id = e.course_id
where e.enrollment_date between '2025-01-12' and '2025-01-18'
and c.fee > 800000 order by c.fee desc;

select s.name, s.email, c.course_name, c.fee from enrollments e
join students s on s.student_id = e.student_id
join courses c on c.course_id = e.course_id
...
order by e.enrollment_date limit 3;
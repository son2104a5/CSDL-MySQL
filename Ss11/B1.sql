...
from employees where Salary >= 15000000 with check option;

select * from employeebranch;
select * from highsalaryemployees;

-- show create view employeeBranch;
...
delete from employees where branchId in (select branchId from branch where branchName = 'Chi nhánh Hà Nội');
